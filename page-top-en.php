...
<section id="top_main">
	<div id="main_img" class="list">
		...
		<?php include("inc/lang_en.php"); ?>
		<div id="top_menu" class="lang_en">
			<div class="logo">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/common/logo.png" alt="NAOKI SAKATA Website"
					title="NAOKI SAKATA Website">
			</div>
			<?php include("inc/p_nav_en.php"); ?>
		</div>
	</div>
...
<div id="container">
	<section id="c_1">
		...
		<div class="news_l list top-page">
			...
			<?php endwhile; else: ?>
			<p class="no_post">There are no posts.</p>
		...
		<div id="view_a">
			<a href="<?php echo home_url() ?>/category/en/news_en/">
